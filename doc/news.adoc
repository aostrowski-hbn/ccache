...
- Added support for the `icpx` (Intel C++) and `dpcpp` (Intel SYCL) compiler
  names, mapping them to the `icx` compiler type.

- Added support for SYCL-specific compiler options: `-fsycl-targets`,
  `-fsycl-host-compiler`, `-fsycl-host-compiler-options` and
